...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        maxQ_action = max(self.Q[self.state], key=(lambda key: self.Q[self.state][key]))
        maxQ = self.Q[self.state][maxQ_action]
    ...
    def choose_action(self, state):
        ...
        if ran_float <= self.epsilon or self.learning == False:
